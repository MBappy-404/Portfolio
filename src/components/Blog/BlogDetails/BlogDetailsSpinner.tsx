...
export const BlogDetailSkeleton = () => {
  return (
    <div className="min-h-screen lg:container max-w-[1400px]   bg-[#F9F9FB] dark:bg-[#0F0F15] py-36 px-4 animate-pulse w-full">
      <div className="  mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-20 h-6 rounded-full bg-gray-300 dark:bg-gray-700" />
          </div>

          {/* Title */}
          <div className="h-10 w-5/6 bg-gray-300 dark:bg-gray-700 rounded" />

          {/* Image */}
          <div className="w-full h-96 rounded-2xl bg-gray-300 dark:bg-gray-700" />

          {/* Author */}
          <div className="flex items-center gap-4 p-6 rounded-xl bg-white dark:bg-[#1A1A24]">
          ...
          <div className="space-y-3">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className={`h-4 rounded bg-gray-300 dark:bg-gray-700 ${i % 3 === 0 ? "w-full" : i % 3 === 1 ? "w-4/5" : "w-2/3"}`}
              />
            ))}
          </div>
        </div>
