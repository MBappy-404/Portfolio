...
const Card = ({ i, title, description, src, url, color, progress, range, targetScale }: CardProps) => {
  ...
  return (
    <div ref={container} className="h-screen flex items-center justify-center sticky top-0">
      ...
      >
        <h2 className="text-center m-0 text-2xl font-semibold">{title}</h2>
        <div className="flex h-full mt-12 gap-12">
          {/* Description */}
          <div className="w-2/5 relative top-1/10">
          ...
          {/* Image Container */}
          <div className="w-3/5 h-full rounded-[25px] overflow-hidden relative">
            <motion.div
