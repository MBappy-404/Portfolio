    ...
    <div className="mb-20 mt-10 ">
      ...
      <ThreeDScrollTriggerContainer>
        ...
        <ThreeDScrollTriggerRow baseVelocity={5} direction={1} className="py-2">
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28  rounded-2xl shadow-sm bg-[#61DAFB]/10 border border-[#61DAFB]/40">
          ...
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28 rounded-2xl shadow-sm bg-[#3178C6]/10 border border-[#3178C6]/40">
        ...
        <ThreeDScrollTriggerRow
          ...
          className="py-6"
        >
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28 rounded-2xl shadow-sm bg-[#68A063]/10 border border-[#68A063]/40">
          ...
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28 rounded-2xl shadow-sm bg-[#0C344B]/30 border border-[#0C344B]/60">
            <span className="text-[#1b6a97] text-sm md:text-base font-bold">Prisma</span>
          </div>
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28 rounded-2xl shadow-sm bg-[#336791]/10 border border-[#336791]/40">
            <span className="text-[#336791] text-sm md:text-base font-bold">PostgreSQL</span>
          </div>
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28 rounded-2xl shadow-sm bg-[#EF4444]/10 border border-[#EF4444]/40">
        ...
        <ThreeDScrollTriggerRow baseVelocity={6} direction={1} className="py-2">
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28 rounded-2xl shadow-sm bg-[#181717]/70 border border-[#282626]">
            <span className="text-gray-200  text-sm md:text-basefont-bold">GitHub</span>
          </div>
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28 rounded-2xl shadow-sm bg-[#007ACC]/10 border border-[#007ACC]/40">
          ...
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28 rounded-2xl shadow-sm bg-[#E34F26]/10 border border-[#E34F26]/40">
            <span className="text-[#E34F26] text-sm md:text-base font-bold">Vercel</span>
          </div>
          <div className="flex items-center mx-5 justify-center w-20 h-20 md:w-28 md:h-28 rounded-2xl shadow-sm bg-[#1572B6]/10 border border-[#1572B6]/40">
