...
const ContactPage = () => {
  ...
  return (
    <div
      className={`min-h-screen pt-36 transition-colors duration-300`}
    >
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className={`text-lg ${theme === 'dark' ? 'text-[#A0A0B0]' : 'text-[#6A6A7A]'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                } focus:ring-2 focus:ring-[#6c2bd9]/20 transition-colors`}
              />
              {errors.name && (
